...
public class CTNHCommonTooltips {
    ...
    public static MutableComponent PARALLEL_HATCH = Component.translatable("ctnh.common_tooltip.parallel_hatch")
            .withStyle(ChatFormatting.GOLD);
    public static MutableComponent SUBTICK_PARALLEL = Component.translatable("ctnh.common_tooltip.subtick_overclock")
            .withStyle(ChatFormatting.YELLOW);
    public static MutableComponent PERFECT_OVERCLOCK = Component.translatable("ctnh.common_tooltip.perfect_overclock")
