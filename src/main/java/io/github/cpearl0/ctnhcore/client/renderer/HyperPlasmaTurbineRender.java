...
public class HyperPlasmaTurbineRender extends DynamicRender<IMachineFeature, HyperPlasmaTurbineRender> {
    ...
    public static final DynamicRenderType<IMachineFeature, HyperPlasmaTurbineRender> TYPE = new DynamicRenderType<>(
            CODEC);
    ...
    @Override
    public void render(IMachineFeature feature, float v, PoseStack poseStack, MultiBufferSource multiBufferSource,
                       int i, int i1) {
        ...
        // fluidBlockRenderer.drawPlane(Direction.WEST,
        // HyperPlasmaTurbineRegister.blockOffsetWEST0,stack.last().pose(),consumer,cachedFluid,RenderUtil.FluidTextureType.FLOWING,combinedOverlay,center);
        // fluidBlockRenderer.drawPlane(Direction.EAST,
        // HyperPlasmaTurbineRegister.blockOffsetEAST0,stack.last().pose(),consumer,cachedFluid,RenderUtil.FluidTextureType.FLOWING,combinedOverlay,center);
        //
        // }
        // }
    }
