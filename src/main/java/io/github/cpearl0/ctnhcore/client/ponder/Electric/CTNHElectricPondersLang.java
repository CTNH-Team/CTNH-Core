...
public class CTNHElectricPondersLang {
    ...
    @CN("碳刷")
    @EN("Carbon Brushes")
    static Lang CarbonBrushesTitle;
    @Key("ponder.carbon_brushes.header")
    @CN("磁电机发电")
    @EN("Magneto generated electricity")
    static Lang CarbonBrushesHeader;
    @Key("ponder.carbon_brushes.text_1")
    @CN("这是碳刷。它可以将动能转化为电能。")
    @EN("This is carbon brushes. It can convert kinetic energy into electrical energy.")
    static Lang CarbonBrushesText1;
    @Key("ponder.carbon_brushes.text_2")
    @CN("为了提供足够的动能，你需要发电机线圈。")
    @EN("To provide sufficient kinetic energy, you need generator coils.")
    static Lang CarbonBrushesText2;
    @Key("ponder.carbon_brushes.text_3")
