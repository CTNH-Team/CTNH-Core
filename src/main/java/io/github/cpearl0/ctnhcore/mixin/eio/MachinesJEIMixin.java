...
public class MachinesJEIMixin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack((ItemLike) MachineBlocks.ENCHANTER.get()),
                new RecipeType[] { EnchanterCategory.TYPE });
        registration.addRecipeCatalyst(new ItemStack((ItemLike) MachineBlocks.SLICE_AND_SPLICE.get()),
                new RecipeType[] { SlicingRecipeCategory.TYPE });
        registration.addRecipeCatalyst(new ItemStack((ItemLike) MachineBlocks.SOUL_BINDER.get()),
                new RecipeType[] { SoulBindingCategory.TYPE });
    }
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        registration.addRecipeCategories(
                new IRecipeCategory[] { new EnchanterCategory(registration.getJeiHelpers().getGuiHelper()) });
        registration.addRecipeCategories(
                new IRecipeCategory[] { new SlicingRecipeCategory(registration.getJeiHelpers().getGuiHelper()) });
        registration.addRecipeCategories(
                new IRecipeCategory[] { new SoulBindingCategory(registration.getJeiHelpers().getGuiHelper()) });
    }
