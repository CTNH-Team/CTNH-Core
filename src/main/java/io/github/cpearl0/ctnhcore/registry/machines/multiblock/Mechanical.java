...
public class Mechanical {
    ...
    public final static MultiblockMachineDefinition MECHANICAL_CENTRIFUGE = REGISTRATE
            ...
            .pattern(definition -> FactoryStaticBlockPattern.start()
                    ...
                    .aisle("#############", "#############", "#####AAA#####", "#####AAA#####", "#####AAA#####", "###BBCCCBB###")
                    .aisle("####DDDDD####", "#############", "#############", "#####E#E#####", "#############", "##B##C#C##B##")
                    .aisle("###DDDDDDD###", "#####DDD#####", "#############", "#####E#E#####", "#############", "##B##C#C##B##")
                    .aisle("###DDDDDDD###", "####DDDDD####", "AAA#######AAA", "AAAEEFFFEEAAA", "AAA#######AAA", "#BCCCGGGCCCB#")
                    .aisle("###DDDDDDD###", "####DDHDD####", "AAA###H###AAA", "AAA##FHF##AAA", "AAA###H###AAA", "#BC##GHG##CB#")
                    .aisle("###DDDDDDD###", "####DDDDD####", "AAA#######AAA", "AAAEEFFFEEAAA", "AAA#######AAA", "#BCCCGGGCCCB#")
                    .aisle("###DDDDDDD###", "#####DDD#####", "#############", "#####E#E#####", "#############", "##B##C#C##B##")
                    .aisle("####DD@DD####", "#############", "#############", "#####E#E#####", "#############", "##B##C#C##B##")
                    .aisle("#############", "#############", "#####AAA#####", "#####AAA#####", "#####AAA#####", "###BBCCCBB###")
                    .aisle("#############", "#############", "#####AAA#####", "#####AAA#####", "#####AAA#####", "#####BBB#####")
                    .aisle("#############", "#############", "#####AAA#####", "#####AAA#####", "#####AAA#####", "#############")
