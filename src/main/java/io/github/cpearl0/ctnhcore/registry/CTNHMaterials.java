...
public class CTNHMaterials {
    ...
    public static final Material Rheniite = new Material.Builder(GTCEu.id("rheniite"))
            ...
            .buildAndRegister();
    public static final Material AU_PD_PT_SOLUTION = new Material.Builder(GTCEu.id("au_pd_pt_solution"))
            .liquid().color(0xDAA520)
            .components(Gold, 1, Palladium, 1, Platinum, 1, Chlorine, 14, Hydrogen, 2)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material INSOLUBLE_RESIDUE = new Material.Builder(GTCEu.id("insoluble_residue"))
            .dust().color(0x696969)
            .components(Silver, 1, Lead, 1, Ruthenium, 1, Rhodium, 1, Osmium, 1, Iridium, 1, Chlorine, 2, Sulfur, 1, Oxygen, 8)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material CRUDE_GOLD = new Material.Builder(GTCEu.id("crude_gold"))
            .dust().color(0xFFD700)
            .components(Gold, 1, Copper,1)
            .buildAndRegister();
    public static final Material AMMONIUM_HEXACHLOROPLATINATE = new Material.Builder(GTCEu.id("ammonium_hexachloroplatinate"))
            .dust().color(0xFFFF00)
            .components(Nitrogen, 2, Hydrogen, 8, Platinum, 1, Chlorine, 6)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material DIAMMINE_PALLADIUM_CHLORIDE = new Material.Builder(GTCEu.id("diammine_palladium_chloride"))
            .dust().color(0xFF4500)
            .components(Nitrogen, 2, Hydrogen, 6, Palladium, 1, Chlorine, 2)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material SILVER_CHLORIDE = new Material.Builder(GTCEu.id("silver_chloride"))
            .dust().color(0xC0C0C0)
            .components(Silver, 1, Chlorine, 1)
            .buildAndRegister();
    public static final Material SODIUM_PEROXIDE = new Material.Builder(GTCEu.id("sodium_peroxide"))
            .dust().color(0xFFFF00)
            .components(Sodium, 2, Oxygen, 2)
            .buildAndRegister();
    public static final Material SodiumOsmate = new Material.Builder(GTCEu.id("sodium_osmate"))
            .dust().color(0x2E8B57)
            .components(Sodium, 2, Osmium, 1, Oxygen, 6, Hydrogen, 2)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material OxalicAcid = new Material.Builder(GTCEu.id("oxalic_acid"))
            .liquid()
            .color(0xFFFFFF)
            .iconSet(FINE)
            .components(Carbon, 2, Hydrogen, 2, Oxygen, 4)
            .buildAndRegister();
    public static final Material Pt_Pd_CHLORIDE_SOLUTION = new Material.Builder(GTCEu.id("pt_pd_chloride_solution"))
            .liquid()
            .color(0x8A2BE2)
            .components(Platinum, 1, Palladium, 1, Chlorine, 10, Hydrogen, 2)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material PALLADIUM_CHLORIDE_SOLUTION = new Material.Builder(GTCEu.id("palladium_chloride_solution"))
            .liquid()
            .color(0xFF4500)
            .components(Palladium, 1, Chlorine, 4, Hydrogen, 2)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material PLATINUM_BLACK = new Material.Builder(GTCEu.id("platinum_black"))
            .dust()
            .color(0x000000).iconSet(SHINY)
            .components(Platinum, 1)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material OSMIUM_TETROXIDE_GAS = new Material.Builder(GTCEu.id("osmium_tetroxide_gas"))
            ...
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material RU_RH_IR_RESIDUE = new Material.Builder(GTCEu.id("ru_rh_ir_residue"))
            .dust()
            .color(0x2F4F4F)
            .iconSet(SHINY)
            .components(Ruthenium, 1, Rhodium, 1, Iridium, 1, Oxygen, 7)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material RUTHENIUM_TETRACHLORIDE_GAS = new Material.Builder(GTCEu.id("ruthenium_tetrachloride_gas"))
            .gas(new FluidBuilder().temperature(600))
            .color(0x8A2BE2)
            .components(Ruthenium, 1, Chlorine, 4)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material IRIDIUM_METAL_SPONGE = new Material.Builder(GTCEu.id("iridium_sponge"))
            .dust().color(0x3D0C02)
            .components(Iridium, 1)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material RH_IR_CHLORIDE_RESIDUE = new Material.Builder(GTCEu.id("rh_ir_chloride_residue"))
            .dust()
            .color(0x4B0082)
            .iconSet(METALLIC)
            .components(Rhodium, 2, Iridium, 1, Chlorine, 7)
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material SodiumRutheniate = new Material.Builder(GTCEu.id("sodium_rutheniate"))
            .dust()
            .color(0x4169E1)
            .iconSet(SHINY)
            ...
            .flags(DISABLE_DECOMPOSITION)
            .buildAndRegister();
    public static final Material ZincSulfate = new Material.Builder(GTCEu.id("zinc_sulfate"))
            .dust()
            .color(0x87CEEB)
            .iconSet(FINE)
