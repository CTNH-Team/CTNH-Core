...
public class TwilightForestOres {
    ...
    public static GTOreDefinition CRYOLITE_VEIN = create(CTNHCore.id("cryolite_vein_tf"), vein -> vein.weight(70)
            .clusterSize(40)
            .density(0.25F)
    ...
    public static GTOreDefinition STEEL_LEAF_VEINN = create(CTNHCore.id("steel_leaf_vein_tf"), vein -> vein.weight(20)
            .clusterSize(40)
            .density(0.35F)
            .discardChanceOnAirExposure(0)
            .layer(CTNHWorldgenLayers.TWILIGHT)
    ...
    public static GTOreDefinition LICH_BONE_VEIN = create(CTNHCore.id("lich_bone_vein_tf"), vein -> vein.weight(20)
            .clusterSize(45)
            .density(0.35F)
            .discardChanceOnAirExposure(0)
            .layer(CTNHWorldgenLayers.TWILIGHT)
    ...
    public static GTOreDefinition TOXIC_SWAMP_AMBER_VEIN = create(CTNHCore.id("toxic_swamp_amber_vein_tf"),
            vein -> vein.weight(50)
                    .clusterSize(35)
                    .density(0.45F)
                    .discardChanceOnAirExposure(0)
    ...
    public static GTOreDefinition ILLUSION_IRON_VEIN = create(CTNHCore.id("illusion_iron_vein_tf"), vein -> vein.weight(50)
            .clusterSize(25)
            .density(0.45F)
            .discardChanceOnAirExposure(0)
            .layer(CTNHWorldgenLayers.TWILIGHT)
    ...
    public static GTOreDefinition ARCTIC_CRYSTAL_CORE_VEIN = create(CTNHCore.id("arctic_crystal_core_vein_tf"),
            vein -> vein.weight(50)
                    .clusterSize(25)
                    .density(0.45F)
                    .discardChanceOnAirExposure(0)
    ...
    public static GTOreDefinition DRAGONFLAME_VEIN = create(CTNHCore.id("dragonflame_vein_tf"), vein -> vein.weight(50)
            .clusterSize(35)
            .density(0.55F)
            .discardChanceOnAirExposure(0)
            .layer(CTNHWorldgenLayers.TWILIGHT)
    ...
    public static GTOreDefinition ECLIPSE_SHADOW_VEIN = create(CTNHCore.id("eclipse_shadow_vein_tf"),
            vein -> vein.weight(50)
                    .clusterSize(45)
                    .density(0.25F)
                    .discardChanceOnAirExposure(0)
    ...
    public static GTOreDefinition LIGHTNING_VEIN_VEIN = create(CTNHCore.id("thunderstrike_vein_tf"),
            vein -> vein.weight(50)
                    .clusterSize(65)
                    .density(0.65F)
                    .discardChanceOnAirExposure(0)
    ...
    public static GTOreDefinition ARSENIC_VEIN = create(CTNHCore.id("arsenic_vein_tf"), vein -> vein.weight(10)
            .clusterSize(40)
            .density(0.25F)
            .discardChanceOnAirExposure(0)
            .layer(CTNHWorldgenLayers.TWILIGHT)
    ...
    public static final GTOreDefinition APATITE_VEIN_TF = create(
            CTNHCore.id("apatite_vein_tf"), vein -> {
                vein.clusterSize(30).weight(40).layer(CTNHWorldgenLayers.TWILIGHT).density(0.25f)
                        ...
                        .layeredVeinGenerator(generator -> {
                            generator.buildLayerPattern(pattern -> {
                                pattern.layer(l -> l.weight(1).mat(GTMaterials.Apatite).size(2, 4))
                                        .layer(l -> l.weight(1).mat(GTMaterials.Pyrochlore).size(2, 4));
                            });
                        }).surfaceIndicatorGenerator(indicator -> {
    ...
    public static final GTOreDefinition SALTS_VEIN_TF = create(
            CTNHCore.id("salts_vein_tf"), vein -> {
                vein.clusterSize(30).weight(50).layer(CTNHWorldgenLayers.TWILIGHT).density(0.2f)
                        ...
                        .layeredVeinGenerator(generator -> {
                            generator.buildLayerPattern(pattern -> {
                                pattern.layer(l -> l.weight(2).mat(GTMaterials.RockSalt).size(2, 4))
