...
import static com.gregtechceu.gtceu.api.data.worldgen.generator.indicators.SurfaceIndicatorGenerator.IndicatorPlacement.BELOW;
...
public class NetherOres {
    ...
    public static GTOreDefinition NICKEL_VEIN_OW = create(CTNHCore.id("nickel_vein_nt"), vein -> vein
            .weight(40)
            .clusterSize(40)
            .density(0.25F)
    ...
    public static final GTOreDefinition MONAZITE_VEIN = create(CTNHCore.id("monazite_vein_nt"), vein -> vein
            .clusterSize(UniformInt.of(25, 30)).density(0.25f).weight(30)
            .layer(WorldGenLayers.NETHERRACK)
    ...
    public static final GTOreDefinition REDSTONE_VEIN = create(CTNHCore.id("redstone_vein_nt"), vein -> vein
    ...
    public static final GTOreDefinition BERYLLIUM_VEIN = create(CTNHCore.id("beryllium_vein_nt"), vein -> vein
            .clusterSize(UniformInt.of(50, 60)).density(0.75f).weight(30)
            .layer(WorldGenLayers.NETHERRACK)
    ...
    public static final GTOreDefinition MOLYBDENUM_VEIN = create(CTNHCore.id("molybdenum_vein_nt"), vein -> vein
            .clusterSize(UniformInt.of(25, 30)).density(0.25f).weight(20)
            .layer(WorldGenLayers.NETHERRACK)
    ...
    public static final GTOreDefinition TETRAHEDRITE_VEIN = create(CTNHCore.id("tetrahedrite_vein_nt"), vein -> vein
    ...
    public static final GTOreDefinition BANDED_IRON_VEIN = create(CTNHCore.id("banded_iron_vein_nt"), vein -> vein
            .clusterSize(UniformInt.of(40, 50)).density(1.0f).weight(30)
            .layer(WorldGenLayers.NETHERRACK)
            .heightRangeUniform(20, 40)
            .biomes(BiomeTags.IS_NETHER)
            .layeredVeinGenerator(generator -> generator
    ...
    public static final GTOreDefinition TOPAZ_VEIN = create(CTNHCore.id("topaz_vein_nt"), vein -> vein
            .clusterSize(UniformInt.of(25, 30)).density(0.25f).weight(50)
            .layer(WorldGenLayers.NETHERRACK)
            .heightRangeUniform(80, 120)
            .biomes(BiomeTags.IS_NETHER)
            .layeredVeinGenerator(generator -> generator
    ...
    public static final GTOreDefinition SULFUR_VEIN = create(CTNHCore.id("sulfur_vein_nt"), vein -> vein
            .clusterSize(UniformInt.of(30, 40)).density(0.2f).weight(50)
            .layer(WorldGenLayers.NETHERRACK)
    ...
    public static final GTOreDefinition SALTPETER_VEIN = create(CTNHCore.id("saltpeter_vein_nt"), vein -> vein
            .clusterSize(UniformInt.of(30, 40)).density(0.25f).weight(50)
            .layer(WorldGenLayers.NETHERRACK)
            .heightRangeUniform(80, 120)
            .biomes(BiomeTags.IS_NETHER)
            .layeredVeinGenerator(generator -> generator
    ...
    public static final GTOreDefinition MANGANESE_VEIN = create(CTNHCore.id("manganese_vein_nt"), vein -> vein
            .clusterSize(UniformInt.of(50, 70)).density(0.75f).weight(30)
            .layer(WorldGenLayers.NETHERRACK)
    ...
    public static final GTOreDefinition CERTUS_QUARTZ_VEIN = create(CTNHCore.id("certus_quartz_nt"), vein -> vein
            .clusterSize(UniformInt.of(25, 30)).density(0.25f).weight(40)
            .layer(WorldGenLayers.NETHERRACK)
            .heightRangeUniform(80, 120)
            .biomes(BiomeTags.IS_NETHER)
            .layeredVeinGenerator(generator -> generator
    ...
    public static GTOreDefinition ANCIENT_DEBRIS_VEIN = create(CTNHCore.id("ancient_debris_vein_nt"),
            vein -> vein.weight(10).clusterSize(35)
                    .density(0.4F)
                    .discardChanceOnAirExposure(0)
                    .layer(WorldGenLayers.NETHERRACK)
                    .dimensions(ResourceLocation.tryParse("minecraft:the_nether"))
    ...
    public static final GTOreDefinition BAUXITE_VEIN_NETHER = create(CTNHCore.id("bauxite_vein_nt"), vein -> vein
