...
public class CTNHPlacements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> ctx) {
        ...
        PlacementUtils.register(ctx, ASTRAL_TREE, featureLookup.getOrThrow(CTNHConfiguredFeatures.ASTRAL_TREE),
                new BiomePlacement(List.of(
                        new BiomeWeightModifier(
                                () -> HolderSet.direct(biomeLookup.getOrThrow(CTNHBiomes.PLAGUE_WASTELAND)), 50))),
                CountPlacement.of(3),
        ...
        PlacementUtils.register(ctx, ASTRAL_LAKE_UNDERGROUND,
                featureLookup.getOrThrow(CTNHConfiguredFeatures.ASTRAL_LAKE),
