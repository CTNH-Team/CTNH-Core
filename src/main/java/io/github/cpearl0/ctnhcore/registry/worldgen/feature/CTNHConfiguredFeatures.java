...
public class CTNHConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> ctx) {
        ...
        FeatureUtils.register(ctx, ASTRAL_FLOWER, Feature.FLOWER,
                CTNHConfiguredFeatures.grassPatch(new WeightedStateProvider(flower), 64));
        ...
        FeatureUtils.register(ctx, ASTRAL_GRASS, Feature.RANDOM_PATCH,
                CTNHConfiguredFeatures.grassPatch(new WeightedStateProvider(grass), 64));
        FeatureUtils.register(ctx, ASTRAL_LAKE, Feature.LAKE,
                new LakeFeature.Configuration(
                        BlockStateProvider
                                .simple(CTNHMaterials.starlight.getFluid().defaultFluidState().createLegacyBlock()),
