...
public class CTNHElements {
    ...
    public static final Element COLORFUL_GEM = new Element(1000, 1000, -1, null, "colorful_gem", "§cC§eO§aL§9O§dR",
            false);
    public static final Element IF = GTElements.createAndRegister(166, 213, -1, null, "Infinity Catalyst", "If", false);
    public static final Element SpNt = GTElements.createAndRegister(167, 233, -1, null, "Space Neutronium", "SpNt",
            false);
