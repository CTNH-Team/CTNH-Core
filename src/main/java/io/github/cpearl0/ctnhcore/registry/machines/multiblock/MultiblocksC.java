...
public class MultiblocksC {
    ...
    public static final MultiblockMachineDefinition CNC_ALLOY_SMELTER = REGISTRATE
            ...
            .recipeModifiers(GTRecipeModifiers.PARALLEL_HATCH, CTNHRecipeModifiers::ebfOverclock,
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .aisle("###AABBBBBAA###", "###############", "###############", "###############",
                            ...
                            "###############", "###############", "###############", "###############",
                            "###############", "###############", "###############")
                    .aisle("##ABBCCCCCBBA##", "#####DDDDD#####", "#####DDDDD#####", "#####DDDDD#####",
                            "###############", "###############", "###############", "###############",
                            "###############", "###############", "###############", "###############",
                            "###############", "###############", "####AAAAAAA####")
                    .aisle("#ABCCEEEEECCBA#", "###DD#####DD###", "###DD#####DD###", "###DD#####DD###",
                            "###AAFFFFFAA###", "###############", "###############", "###############",
                            "###############", "###############", "###############", "###############",
                            "###############", "#####AAAAA#####", "###AACCGCCAA###")
                    .aisle("#ABCEHBBBHECBA#", "###D#######D###", "###D#######D###", "###D#######D###",
                            "###AA#####AA###", "####AEEEEEA####", "####AEEEEEA####", "####AFFFFFA####",
                            "####AFFFFFA####", "####AFFFFFA####", "####AFFFFFA####", "####AFFFFFA####",
                            "####AEEEEEA####", "####A#####A####", "##AAGAAGAAGAA##")
                    .aisle("ABCEHBHBHBHECBA", "##D#########D##", "##D#########D##", "##D#########D##",
                            "###F#######F###", "####E#####E####", "####E#####E####", "####FGCCCGF####",
                            "####FGHHHGF####", "####FGHHHGF####", "####FGHHHGF####", "####FGCCCGF####",
                            "####EGGGGGE####", "###A#G###G#A###", "##ACAGGGGGACA##")
                    .aisle("ABCEBHBBBHBECBA", "##D###B#B###D##", "##D###B#B###D##", "##D###B#B###D##",
                            "###F##B#B##F###", "####E#B#B#E####", "####E#B#B#E####", "####FCB#BCF####",
                            "####FHB#BHF####", "####FHB#BHF####", "####FHB#BHF####", "####FCB#BCF####",
                            "####EGB#BGE####", "###A##BBB##A###", "##ACAGCGCGACA##")
                    .aisle("ABCEBBBCBBBECBA", "##D####G####D##", "##D####G####D##", "##D####G####D##",
                            "###F###G###F###", "####E##G##E####", "####E##G##E####", "####FC#C#CF####",
                            "####FH#H#HF####", "####FH#H#HF####", "####FH#H#HF####", "####FC#C#CF####",
                            "####EG###GE####", "###A##BBB##A###", "##AGGGGIGGGGA##")
                    .aisle("ABCEBHBBBHBECBA", "##D###B#B###D##", "##D###B#B###D##", "##D###B#B###D##",
                            "###F##B#B##F###", "####E#B#B#E####", "####E#B#B#E####", "####FCB#BCF####",
                            "####FHB#BHF####", "####FHB#BHF####", "####FHB#BHF####", "####FCB#BCF####",
                            "####EGB#BGE####", "###A##BBB##A###", "##ACAGCGCGACA##")
                    ...
                    .aisle("#ABCCEEEEECCBA#", "###DD#####DD###", "###DD#####DD###", "###DD#####DD###",
                            ...
                            "###############", "###############", "###############", "###############",
                            "###############", "#####AAAAA#####", "###AACCGCCAA###")
                    .aisle("##ABBCCCCCBBA##", "#####DDDDD#####", "#####DD@DD#####", "#####DDDDD#####",
                            "###############", "###############", "###############", "###############",
                            "###############", "###############", "###############", "###############",
                            "###############", "###############", "####AAAAAAA####")
                    .aisle("###AABBBBBAA###", "###############", "###############", "###############",
            ...
            .additionalDisplay((controller, components) -> {
                if (controller instanceof ICoilMachine coilMachine &&
                        controller instanceof ITieredMachine tieredMachine && controller.isFormed()) {
