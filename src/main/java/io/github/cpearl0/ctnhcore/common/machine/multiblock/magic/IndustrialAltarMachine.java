...
public class IndustrialAltarMachine extends WorkableElectricMultiblockMachine implements ITieredMachine {
    ...
    public void addDisplayText(List<Component> textList) {
        ...
        textList.add(textList.size(), Component.translatable("ctnh.multiblock.industrial_altar.info.current_lp",String.format("%d",lp)));
         textList.add(textList.size(), Component.translatable("ctnh.multiblock.industrial_altar.info.max_lp",String.format("%d",max_lp)));
    }
    @Override
    ...
    public IndustrialAltarMachine(IMachineBlockEntity holder){
        super(holder);
        var tier = getTier();
    ...
    public static ModifierFunction recipeModifier(MetaMachine machine, GTRecipe recipe) {
        if (machine instanceof IndustrialAltarMachine wmachine) {
