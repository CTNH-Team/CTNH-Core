...
public class INFFluidDrillMachine extends RecipeElectricMultiblockMachine implements ITieredMachine {
    ...
    public static Block getCasingState(int tier) {
        return (Block) CTNHBlocks.CASING_NEUTRONIUM_ALLOY_BLOCK.get();
    }
    ...
    public static ResourceLocation getBaseTexture(int tier) {
        return CTNHCore.id("block/casings/nq_neutronium_casing");
    }
}
