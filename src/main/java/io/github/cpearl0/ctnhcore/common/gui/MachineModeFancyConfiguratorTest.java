...
public class MachineModeFancyConfiguratorTest implements IFancyUIProvider {
    ...
    public Widget createMainPage(FancyMachineUIWidget widget) {
        ...
        var speed_progress = (new ProgressWidget(machine.JEIProgress, 50, 60, 100, 15,
        ...
        var button_m = (new ButtonWidget(10, 60, 15, 15,
                new GuiTextureGroup(new IGuiTexture[] { ResourceBorderTexture.BUTTON_COMMON, new TextTexture("-") }),
                clickData -> {
        ...
        var button_plus = (new ButtonWidget(175, 60, 15, 15,
                new GuiTextureGroup(new IGuiTexture[] { ResourceBorderTexture.BUTTON_COMMON, new TextTexture("+") }),
                clickData -> {
                    if (clickData.button == 0) {
        ...
        var speed_progress2 = (new ProgressWidget(machine.JEIProgress2, 50, 120 - 10, 100, 15,
                new ProgressTexture(CTNHGuiTextures.TEST_BAR, CTNHGuiTextures.TEST_BAR_FULL)
                        .setFillDirection(ProgressTexture.FillDirection.LEFT_TO_RIGHT))
                .setHoverTooltips(target2()));
        var button_m2 = (new ButtonWidget(10, 120 - 10, 15, 15,
                new GuiTextureGroup(new IGuiTexture[] { ResourceBorderTexture.BUTTON_COMMON, new TextTexture("-") }),
                clickData -> {
                    if (clickData.button == 0) {
        ...
        var button_plus2 = (new ButtonWidget(175, 120 - 10, 15, 15,
                new GuiTextureGroup(new IGuiTexture[] { ResourceBorderTexture.BUTTON_COMMON, new TextTexture("+") }),
                clickData -> {
                    if (clickData.button == 0) {
        ...
        var speed_progress3 = (new ProgressWidget(machine.JEIProgress3, 50, 160, 100, 15,
                new ProgressTexture(CTNHGuiTextures.TEST_BAR, CTNHGuiTextures.TEST_BAR_FULL)
                        .setFillDirection(ProgressTexture.FillDirection.LEFT_TO_RIGHT))
                .setHoverTooltips(target3()));
        var button_m3 = (new ButtonWidget(10, 160, 15, 15,
                new GuiTextureGroup(new IGuiTexture[] { ResourceBorderTexture.BUTTON_COMMON, new TextTexture("-") }),
                clickData -> {
                    if (clickData.button == 0) {
        ...
        var button_plus3 = (new ButtonWidget(175, 160, 15, 15,
                new GuiTextureGroup(new IGuiTexture[] { ResourceBorderTexture.BUTTON_COMMON, new TextTexture("+") }),
                clickData -> {
                    if (clickData.button == 0) {
