...
//                "item.gtmthings.advanced_terminal.setting.4.tooltip": "是否启用线圈替换模式(0:不启用,1:启用)\n启用线圈替换模式会将所有线圈替换为线圈等级中指定的线圈。",
        ...
        provider.add("ctnh.multiblock.demon_will_generator.tooltip.1","利用机器两侧的区块内的恶魔意志浓度差发电，浓度差与发电量呈指数关系，当浓度差超过500时，超过500的浓度与发电量改为线性关系");
...
//        provider.addItem(CTNHItems.MODULAR_DYSON_SWARM_T2,"戴森云无人机蜂群MKII");
        ...
        provider.addBlock(CTNHBlocks.FABRIC, "丝绸方块");
        ...
        provider.addBlock(CTNHBlocks.RUNE_STONE_0, "符文石方块-0号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_1, "符文石方块-1号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_2, "符文石方块-2号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_3, "符文石方块-3号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_4, "符文石方块-4号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_5, "符文石方块-5号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_6, "符文石方块-6号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_7, "符文石方块-7号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_8, "符文石方块-8号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_9, "符文石方块-9号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_10, "符文石方块-10号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_11, "符文石方块-11号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_12, "符文石方块-12号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_13, "符文石方块-13号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_14, "符文石方块-14号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_15, "符文石方块-15号");
        provider.addBlock(CTNHBlocks.RUNE_STONE_16, "符文石方块-16号");
