...
public class AssemblyLineRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ASSEMBLY_LINE_RECIPES.recipeBuilder(CTNHCore.id("cnc_alloy_smelter"))
                ...
                .outputItems(MultiblocksC.CNC_ALLOY_SMELTER.asStack(), 1)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(CTNHCore.id("parabiotic_bridge"))
                ...
                .inputItems(CustomTags.LuV_CIRCUITS, 4)
                .inputItems(GTMachines.ITEM_IMPORT_BUS[ZPM].asStack(), 1)
                .inputItems(GTMachines.ITEM_EXPORT_BUS[ZPM].asStack(), 1)
                .inputFluids(new FluidStack(Primordial_Serum.getFluid(), 144 * 20))
                .outputItems(CBMachines.PARABIOTIC_BRIDGE.asStack(), 1)
                .stationResearch(
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(CTNHCore.id("consciousness_linker"))
                .inputItems(CBBlocks.NEURAL_NETWORK_CASING.asItem(), 1)
                .inputItems(CTNHBlocks.SUPER_FREEZE_BLOCK.asItem(), 4)
                ...
                .outputItems(CBBlocks.CONSCIOUSNESS_LINKER.asItem(), 4)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(CTNHCore.id("consciousness_controller"))
                .inputItems(CBBlocks.NEURAL_NETWORK_CASING.asItem(), 1)
                .inputItems(CTNHBlocks.BLAZE_BLAST_FURNACE_CASING.asItem(), 4)
                .inputItems(TagPrefix.dust, Praseodymium, 16)
                .inputItems(CTNHItems.HEAVY_PLATE_T2, 4)
                .inputFluids(new FluidStack(CTNHMaterials.Cerrobase140.getFluid(), 144 * 10))
                .inputFluids(new FluidStack(CTNHMaterials.Pyrotheum.getFluid(), 144 * 10))
                .outputItems(CBBlocks.CONSCIOUSNESS_CONTROLLER.asItem(), 4)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(CTNHCore.id("neural_cooling_conduit"))
                ...
                .outputItems(CBBlocks.NEURAL_COOLING_CONDUIT.asItem(), 1)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(CTNHCore.id("hostile_observer"))
                ...
                .inputItems(CTNHItems.HEAVY_PLATE_T3, 16)
                .inputItems(CTNHItems.HEAVY_PLATE_T3, 16)
                .inputItems(CTNHBlocks.CASING_POLYBENZIMIDAZOLE_PIPE.asItem(), 16)
                .inputItems(CASING_POLYTETRAFLUOROETHYLENE_PIPE.asItem(), 4)
                .inputItems(CASING_TITANIUM_PIPE.asItem(), 4)
                .inputItems(CASING_STEEL_PIPE.asItem(), 4)
                .inputItems(CustomTags.UV_CIRCUITS, 16)
                .inputItems(CBBlocks.CONSCIOUSNESS_SENSOR_GLASS.asItem(), 16)
                .inputItems(CBBlocks.NEURAL_NETWORK_CASING.asItem(), 16)
                ...
                .outputItems(CBMultiblocks.HOSTILE_OBSERVER.asStack())
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(CTNHCore.id("advanced_neural_model_accessor"))
                .inputItems(CBBlocks.CONSCIOUSNESS_CONTROLLER.asItem())
                .inputItems(TOOL_DATA_MODULE)
                .inputItems(CBMachines.NEURAL_MODEL_ACCESSOR.asStack())
                ...
                .outputItems(CBMachines.ADVANCED_NEURAL_MODEL_ACCESSOR.asStack())
...
//                .inputItems(CEMachines.ITEM_STOKING_IMPORT_BUS_ME.asStack())
//                .inputItems(CEMachines.FLUID_STOKING_IMPORT_HATCH_ME.asStack())
...
//                .outputItems(ME_ADVANCED_PATTERN_BUFFER.asStack(), 1)
...
//                .inputFluids(new FluidStack(SolderingAlloy.getFluid(), 2880 * 2))
//                .inputFluids(new FluidStack(BorosilicateGlass.getFluid(), 2880 * 4))
//                .outputItems(ME_ADVANCED_PATTERN_BUFFER_PROXY.asStack(), 1)
...
//                .outputItems(ME_ULTIMATE_PATTERN_BUFFER.asStack(), 1)
...
//                .inputFluids(new FluidStack(SolderingAlloy.getFluid(), 2880 * 4))
//                .inputFluids(new FluidStack(BorosilicateGlass.getFluid(), 2880 * 8))
//                .outputItems(ME_ULTIMATE_PATTERN_BUFFER_PROXY.asStack(), 1)
