...
public class GtceuScriptRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("sky_dust"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("ae2:sky_dust")), 13)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("aeternium"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:aeternium_dust")), 4)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("pyrotheum"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:pyrotheum_dust")), 2)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("cryotheum"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:cryotheum_dust")), 2)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("chorusite_alloy_dust"))
                ...
                .inputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:andesite_alloy_dust")))
                .inputItems(new ItemStack(Items.POPPED_CHORUS_FRUIT, 2))
                .inputItems(new ItemStack(Items.DRAGON_BREATH))
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:chorusite_alloy_dust")), 4)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("dibismuthhydroborat"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:dibismuthhydroborat_dust")), 4)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("bismuth_tellurite"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:bismuth_tellurite_dust")), 5)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("circuit_compound"))
                .EUt(15).duration(982)
                .inputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:dibismuthhydroborat_dust")), 3)
                .inputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:bismuth_tellurite_dust")), 2)
                .inputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:indium_gallium_phosphide_dust")))
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:circuit_compound_dust")), 6)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("samarium_dysprosium_terbium_permanent_magnet_alloy"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:samarium_dysprosium_terbium_permanent_magnet_alloy_dust")), 3)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("nether_essence_crystal_fluid"))
                ...
                .outputFluids(ForgeRegistries.FLUIDS.getValue(ResourceLocation.parse("gtceu:nether_essence_crystal_fluid")), 864)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("eglin_steel_ingot"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:eglin_steel_ingot_dust")), 10)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("eglin_alloy_dust"))
                .EUt(64).duration(150)
                .circuitMeta(4)
                .inputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:eglin_steel_ingot_dust")), 10)
                .inputItems(dust, Sulfur)
                .inputItems(dust, Silver)
                .inputItems(dust, Carbon)
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:eglin_alloy_dust")), 13)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("cement"))
                ...
                .outputFluids(ForgeRegistries.FLUIDS.getValue(ResourceLocation.parse("gtceu:cement")), 14400)
                .save(provider);
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("echo_shard"))
                ...
                .inputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:sculk_dust")), 2)
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:echo_shard_dust")), 5)
                .save(provider);
        ...
        ALLOY_SMELTER_RECIPES.recipeBuilder(CTNHCore.id("andesite_alloy"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:andesite_alloy_ingot")), 2)
                .save(provider);
        ...
        ALLOY_SMELTER_RECIPES.recipeBuilder(CTNHCore.id("dark_steel"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:dark_steel_ingot")))
                .save(provider);
        ...
        MACERATOR_RECIPES.recipeBuilder(CTNHCore.id("ancient_debris_dust"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:ancient_debris_dust")), 4)
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:netherrack_dust")))
        ...
        MACERATOR_RECIPES.recipeBuilder(CTNHCore.id("dried_salt_stone"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:dried_salt_dust")))
                .save(provider);
        ...
        MACERATOR_RECIPES.recipeBuilder(CTNHCore.id("rich_soil"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:rich_soil_dust")), 4)
                .chancedOutput(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:normal_yeast_dust")), 2500, 200)
                .save(provider);
        ...
        MACERATOR_RECIPES.recipeBuilder(CTNHCore.id("rich_soul_soil"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:rich_soul_soil_dust")), 4)
                .chancedOutput(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:crimson_yeast_dust")), 1500, 150)
                .chancedOutput(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:warped_yeast_dust")), 1500, 150)
                .save(provider);
        ...
        for (String stone : stones) {
            MACERATOR_RECIPES.recipeBuilder(CTNHCore.id(stone + "_macerator"))
                    ...
                    .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:" + stone + "_dust")))
                    .chancedOutput(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:" + stone + "_dust")), 1500, 500)
                    .save(provider);
        }
        ...
        MACERATOR_RECIPES.recipeBuilder(CTNHCore.id("sculk_dust"))
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(ResourceLocation.parse("gtceu:sculk_dust")))
                .save(provider);
    }
}
