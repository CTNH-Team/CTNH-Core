...
public class MaterialLang {
    ...
    public static void materials() {
        ...
        translateMaterial(PlatinumOre, "铂金矿");
        translateMaterial(PalladiumOre, "钯金矿");
        ...
        translateMaterial(AmmoniaMonohydrate, "氨水");
