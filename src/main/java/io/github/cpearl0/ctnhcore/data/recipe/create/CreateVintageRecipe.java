...
import com.mo_guang.ctpp.common.recipe.builder.create.vintage.CentrifugationRecipeBuilder;
import com.mo_guang.ctpp.common.recipe.builder.create.vintage.CoilingRecipeBuilder;
import com.mo_guang.ctpp.common.recipe.builder.create.vintage.CurvingRecipeBuilder;
import com.mo_guang.ctpp.common.recipe.builder.create.vintage.HammeringRecipeBuilder;
import com.mo_guang.ctpp.common.recipe.builder.create.vintage.PressurizingRecipeBuilder;
...
public final class CreateVintageRecipe {
    ...
    private static void addVintageImprovementsRecipes(Consumer<FinishedRecipe> provider) {
        ...
        SequencedAssemblyRecipeBuilder.builder(CTNHCore.id("vintageimprovements/steel_gear"))
                ...
                .loops(1)
                .save(provider);
        SequencedAssemblyRecipeBuilder.builder("ctnhcore:vintageimprovements/small_brass_gear")
                ...
                .loops(1)
                .save(provider);
        SequencedAssemblyRecipeBuilder.builder("ctnhcore:vintageimprovements/brass_gear")
                .input(ChemicalHelper.get(TagPrefix.plate, GTMaterials.Brass))
                .transitional(ChemicalHelper.get(TagPrefix.plate, GTMaterials.Brass))
