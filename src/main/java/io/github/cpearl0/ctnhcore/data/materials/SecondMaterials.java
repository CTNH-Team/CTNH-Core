...
public class SecondMaterials {
    ...
    public static void init() {
        ...
        RP1 = REGISTRATE.material(CTNHCore.id("rp_1_mixed_fuel")).cnlang("RP-1混合燃料").fluid().color(0xC02928).iconSet(MaterialIconSet.DULL)
                        .buildAndRegister();

        RP1RocketFuel = REGISTRATE.material(CTNHCore.id("rp_1_rocket_fuel")).cnlang("RP-1火箭燃料").fluid().color(0x9E2A2A).iconSet(MaterialIconSet.DULL)
                        .buildAndRegister();

        Kerosene = REGISTRATE.material(CTNHCore.id("kerosene")).cnlang("煤油").fluid().color(0x752275).iconSet(MaterialIconSet.DULL).buildAndRegister();

        DenseHydrazineMixedFuel = REGISTRATE.material(CTNHCore.id("dense_hydrazine_mixed_fuel")).cnlang("浓缩肼混合燃料").fluid().color(0x833D59).iconSet(MaterialIconSet.DULL)
                        .buildAndRegister();

        Hydrazine = REGISTRATE.material(CTNHCore.id("hydrazine")).cnlang("肼").fluid().color(0xBBBBBB).iconSet(MaterialIconSet.DULL).buildAndRegister();

        EthylAnthraQuinone = REGISTRATE.material(CTNHCore.id("ethyl_anthra_quinone")).cnlang("乙基蒽醌").fluid().color(0xAABE77).iconSet(MaterialIconSet.DULL)
                        .buildAndRegister();

        EthylAnthraHydroQuinone = REGISTRATE.material(CTNHCore.id("ethyl_anthra_hydro_quinone")).cnlang("乙基蒽醌醇").fluid().color(0xC9E08D).iconSet(MaterialIconSet.DULL)
                        .buildAndRegister();

        Anthracene = REGISTRATE.material(CTNHCore.id("anthracene")).cnlang("蒽").fluid().color(0xBBBABA).iconSet(MaterialIconSet.DULL).buildAndRegister();

        MethylhydrazineNitrateRocketFuel = REGISTRATE.material(CTNHCore.id("methylhydrazine_nitrate_rocket_fuel")).cnlang("CN3H7O3火箭燃料").fluid().color(0x613B87)
                        .iconSet(MaterialIconSet.DULL).buildAndRegister();

        MethylHydrazine = REGISTRATE.material(CTNHCore.id("methyl_hydrazine")).cnlang("甲基肼").fluid().color(0x606060).iconSet(MaterialIconSet.DULL)
                        .buildAndRegister();

        UDMHRocketFuel = REGISTRATE.material(CTNHCore.id("udmh_rocket_fuel")).cnlang("H8N4C2O4火箭燃料").fluid().color(0x2AA327).iconSet(MaterialIconSet.DULL)
                        .buildAndRegister();

        UDMH = REGISTRATE.material(CTNHCore.id("udmh")).cnlang("偏二甲肼").fluid().color(0x050543).iconSet(MaterialIconSet.DULL).buildAndRegister();

        OrangeMetal = REGISTRATE.material(CTNHCore.id("orange_metal")).cnlang("橙色金属").dust().color(0xfa7e23).iconSet(MaterialIconSet.ROUGH)
                        .buildAndRegister();

        PhthalicAnhydride = REGISTRATE.material(CTNHCore.id("phthalic_anhydride")).cnlang("邻苯二甲酸酐").dust().color(0x6C863A).iconSet(MaterialIconSet.ROUGH)
                        .buildAndRegister();
        ...
        PotassiumPyrosulfate =
                REGISTRATE.material(CTNHCore.id("potassium_pyrosulfate")).cnlang("焦硫酸钾").dust(). fluid(FluidStorageKeys.MOLTEN, new FluidBuilder())
        ...
        Kaolinite =
                REGISTRATE.material(CTNHCore.id("kaolinite")).cnlang("高岭石").dust().ore().color(0x969090).iconSet(MaterialIconSet.ROUGH)
                        .flags(MaterialFlags.DISABLE_DECOMPOSITION).buildAndRegister();

        Dolomite =
                REGISTRATE.material(CTNHCore.id("dolomite")).cnlang("白云石").dust().ore().color(0x9F9191).iconSet(MaterialIconSet.ROUGH)
                        .flags(MaterialFlags.DISABLE_DECOMPOSITION).buildAndRegister();
        ...
        PlutoniumOxideUraniumMixture =
                REGISTRATE.material(CTNHCore.id("plutonium_oxide_uranium_mixture")).cnlang("氧化钚-铀混合物").dust().components(
        ...
        UraniumCarbideThoriumMixture =
                REGISTRATE.material(CTNHCore.id("uranium_carbide_thorium_mixture")).cnlang("碳化铀-钍混合物").dust().components(
        ...
        ThoriumBasedLiquidFuel =
                REGISTRATE.material(CTNHCore.id("thorium_based_liquid_fuel")).cnlang("钍基流体燃料").fluid().color(0x3b264d).iconSet(MaterialIconSet.METALLIC)
                        .buildAndRegister().setFormula("Th432Li4D2Hg");

        ThoriumBasedLiquidFuelExcited =
                REGISTRATE.material(CTNHCore.id("thorium_based_liquid_fuel_excited")).cnlang("钍基流体燃料(激发态)").fluid().color(0x3f2850)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("*(Th432Li4D2HG)*");

        ThoriumBasedLiquidFuelDepleted =
                REGISTRATE.material(CTNHCore.id("thorium_based_liquid_fuel_depleted")).cnlang("钍基流体燃料(枯竭态)").fluid().color(0x5d5166)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("Th?Pr?B?In?");

        UraniumBasedLiquidFuel =
                REGISTRATE.material(CTNHCore.id("uranium_based_liquid_fuel")).cnlang("铀基流体燃料").fluid().color(0x02ba05).iconSet(MaterialIconSet.METALLIC)
                        .buildAndRegister().setFormula("U36K8Qt4Rn");

        UraniumBasedLiquidFuelExcited =
                REGISTRATE.material(CTNHCore.id("uranium_based_liquid_fuel_excited")).cnlang("铀基流体燃料(激发态)").fluid().color(0x04bc04)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("*(U36K8Qt4Rn)*");

        UraniumBasedLiquidFuelDepleted =
                REGISTRATE.material(CTNHCore.id("uranium_based_liquid_fuel_depleted")).cnlang("铀基流体燃料(枯竭态)").fluid().color(0x576d31)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("PB?Bi?Ba?Xe?");

        PlutoniumBasedLiquidFuel =
                REGISTRATE.material(CTNHCore.id("plutonium_based_liquid_fuel")).cnlang("钚基流体燃料").fluid().color(0xb71213)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("Pu45Nt8Cs16Nq2");

        PlutoniumBasedLiquidFuelExcited =
                REGISTRATE.material(CTNHCore.id("plutonium_based_liquid_fuel_excited")).cnlang("钚基流体燃料(激发态)").fluid().color(0xb81312)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("*(Pu45Nt8Cs16Nq2)*");

        PlutoniumBasedLiquidFuelDepleted =
                REGISTRATE.material(CTNHCore.id("plutonium_based_liquid_fuel_depleted")).cnlang("钚基流体燃料(枯竭态)").fluid().color(0x4e1414)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("Th?Ce?Au?Kr?");

        RadiationProtection =
                REGISTRATE.material(CTNHCore.id("radiation_protection")).cnlang("防辐射").dust().flags(MaterialFlags.GENERATE_FRAME).color(0x4C4C4B)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister();

        NaquadahBasedLiquidFuel =
                REGISTRATE.material(CTNHCore.id("naquadah_based_liquid_fuel")).cnlang("硅岩流体燃料").fluid().color(0x43b54a)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("Nq42Ce16Nd16");

        NaquadahBasedLiquidFuelExcited =
                REGISTRATE.material(CTNHCore.id("naquadah_based_liquid_fuel_excited")).cnlang("硅岩流体燃料(激发态)").fluid().color(0x41b349)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("*(Nq42Ce16Nd16)*");

        NaquadahBasedLiquidFuelDepleted =
                REGISTRATE.material(CTNHCore.id("naquadah_based_liquid_fuel_depleted")).cnlang("硅岩流体燃料(枯竭态)").fluid().color(0x215825)
                        .iconSet(MaterialIconSet.METALLIC).buildAndRegister().setFormula("Nq?Ke?Nd?");

        NeutroniumMixture =
                REGISTRATE.material(CTNHCore.id("neutronium_mixture")).cnlang("中子素混合物").dust().color(0xFFFFFF).secondaryColor(0x000000)
