...
public class AeCrystalScienceRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        CHEMICAL_BATH_RECIPES.recipeBuilder(CTNHCore.id("ender_quartz_seed"))
                ...
                .EUt(VA[HV]).duration(200)
                .save(provider);
        AUTOCLAVE_RECIPES.recipeBuilder(CTNHCore.id("purified_ender_quartz_1"))
                .inputItems(AECSItems.ENDER_QUARTZ_SEED, 1)
                .inputFluids(ENDER_STEEL.getFluid(L))
                .outputItems(AECSItems.PURE_ENDER_QUARTZ, 1)
                .EUt(VA[HV]).duration(600)
                .save(provider);
        CRYSTALLIZER.recipeBuilder(CTNHCore.id("purified_ender_quartz_2"))
        ...
        ALLOY_SMELTER_RECIPES.recipeBuilder(CTNHCore.id("certus_quartz_seed"))
                ...
                .save(provider);
        AUTOCLAVE_RECIPES.recipeBuilder(CTNHCore.id("purified_certus_quartz_crystal_1"))
                ...
                .EUt(VA[HV]).duration(200)
                .save(provider);
        CRYSTALLIZER.recipeBuilder(CTNHCore.id("purified_certus_quartz_crystal_2"))
        ...
        ALLOY_SMELTER_RECIPES.recipeBuilder(CTNHCore.id("nether_quartz_seed"))
                ...
                .save(provider);
        AUTOCLAVE_RECIPES.recipeBuilder(CTNHCore.id("purified_nether_quartz_crystal_1"))
                .inputItems(AECSItems.NETHER_QUARTZ_SEED, 1)
                .inputFluids(DistilledWater.getFluid(100))
                .outputItems(AECSItems.PURE_NETHER_QUARTZ_CRYSTAL, 1)
                .EUt(VA[MV]).duration(200)
                .save(provider);
        CRYSTALLIZER.recipeBuilder(CTNHCore.id("purified_nether_quartz_crystal_2"))
        ...
        BLAST_RECIPES.recipeBuilder(CTNHCore.id("fluix_quartz_seed"))
                ...
                .EUt(VA[HV]).duration(600)
                .save(provider);
        AUTOCLAVE_RECIPES.recipeBuilder(CTNHCore.id("purified_fluix_crystal_1"))
                .inputItems(AECSItems.FLUIX_CRYSTAL_SEED, 1)
                .inputFluids(Redstone.getFluid(1000))
                .outputItems(AECSItems.PURE_FLUIX_CRYSTAL, 1)
                .EUt(VA[HV]).duration(300)
                .save(provider);
        CRYSTALLIZER.recipeBuilder(CTNHCore.id("purified_fluix_crystal_2"))
        ...
        BLAST_RECIPES.recipeBuilder(CTNHCore.id("meteor_seed"))
                ...
                .EUt(VA[HV]).duration(1200)
                .save(provider);
        AUTOCLAVE_RECIPES.recipeBuilder(CTNHCore.id("purified_meteor_crystal_1"))
                .inputItems(AECSItems.METEOR_SEED, 1)
                .inputFluids(Lava.getFluid(1000))
                .outputItems(AECSItems.PURE_METEOR_CRYSTAL, 1)
                .EUt(VA[HV]).duration(300)
                .save(provider);
        CRYSTALLIZER.recipeBuilder(CTNHCore.id("purified_meteor_crystal_2"))
        ...
        MIXER_RECIPES.recipeBuilder(CTNHCore.id("mix_crystal_sand"))
                ...
                .save(provider);
        BLAST_RECIPES.recipeBuilder(CTNHCore.id("resonating_seed_1"))
                ...
                .EUt(VA[HV]).duration(600)
                .save(provider);
        AUTOCLAVE_RECIPES.recipeBuilder(CTNHCore.id("purified_resonating_crystal_1"))
                .inputItems(AECSItems.RESONATING_SEED, 1)
                .inputFluids(BlueSteel.getFluid(L))
                .outputItems(AECSItems.PURE_RESONATING_CRYSTAL, 1)
                .EUt(VA[HV]).duration(600)
                .save(provider);
        CRYSTALLIZER.recipeBuilder(CTNHCore.id("purified_resonating_crystal_2"))
                ...
                .EUt(VA[IV]).duration(300)
                .save(provider);
        ALLOY_SMELTER_RECIPES.recipeBuilder(CTNHCore.id("resonating_seed_2"))
