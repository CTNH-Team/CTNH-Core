...
public class CreateMetallurgyRecipes {
    ...
    private static void addCraftingAndBaseRecipes(Consumer<FinishedRecipe> provider) {
        CompactingRecipeBuilder.builder("createmetallurgy/graphite_blank_mold")
                ...
                .save(provider);
        VanillaRecipeHelper.addShapedRecipe(provider, ResourceLocation.parse("ctnhcore:createmetallurgy/graphite_ingot_mold"),
                CMItems.GRAPHITE_INGOT_MOLD.asStack(),
                "B", "A",
                'A', TagUtil.createItemTag("tools/hammers"),
                'B', CMItems.GRAPHITE_BLANK_MOLD.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, ResourceLocation.parse("ctnhcore:createmetallurgy/graphite_plate_mold"),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, ResourceLocation.parse("ctnhcore:createmetallurgy/sandpaper_belt"),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, ResourceLocation.parse("ctnhcore:createmetallurgy/gauge_attachment"),
    ...
    private static void addOreProcessing(Consumer<FinishedRecipe> provider) {
        ...
        for (String material : MATERIALS) {
            ...
            SplashingRecipeBuilder.builder("createmetallurgy/clean_impure_" + material + "_dust_" + index)
                    ...
                    .result(stack(material.equals("redstone") ? "minecraft:redstone" : "gtceu:" + material + "_dust", 1))
                    .save(provider);
            index++;
        }
    }
