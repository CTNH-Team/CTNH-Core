...
public class PlatinumLineMaterials {
    ...
    public static void init() {
        ...
        PlatinumOre = REGISTRATE.material(CTNHCore.id("platinum_ore"))
                .cnlang("铂金矿")
                .ore()
                .dust()
                .color(0xFFD700)
        ...
        PalladiumOre = REGISTRATE.material(CTNHCore.id("palladium_ore"))
                .cnlang("钯金矿")
                .ore()
                .dust()
                .color(0xD8BFD8)
        ...
        IridiumDioxide = REGISTRATE.material(CTNHCore.id("iridium_dioxide"))
                .cnlang("二氧化铱").dust().color(0xA2BFFF)
                .iconSet(METALLIC)
        ...
        DenitratedGoldPlatinumPalladiumSolution = REGISTRATE
                .material(CTNHCore.id("denitrated_gold_platinum_palladium_solution"))
                .cnlang("除硝金-铂-钯酸性溶液")
                .liquid()
                .color(0x8A2BE2)
                .iconSet(SHINY)
        ...
        FerricSulfate = REGISTRATE.material(CTNHCore.id("ferric_sulfate"))
                .cnlang("硫酸铁")
                .dust()
                .liquid()
                .color(0xB22222)
        ...
        FerrousSulfate = REGISTRATE.material(CTNHCore.id("ferrous_sulfate"))
                .cnlang("酸性硫酸亚铁")
                .dust()
                .liquid()
                .color(0x2E8B57)
        ...
        ChloroplatinicChloropalladicSolution = REGISTRATE
                .material(CTNHCore.id("chloroplatinic_chloropalladic_solution"))
                .cnlang("氯铂酸-氯钯酸混合溶液")
                .liquid()
                .color(0x9370DB)
                .iconSet(SHINY)
        ...
        AmmoniumChloroplatinate = REGISTRATE.material(CTNHCore.id("ammonium_chloroplatinate"))
                .cnlang("氯铂酸铵")
                .dust()
                .color(0xFFD700)
                .iconSet(BRIGHT)
        ...
        AmmoniaMonohydrate = REGISTRATE.material(CTNHCore.id("ammonia_monohydrate"))
                .cnlang("氨水")
                .liquid()
                .color(0xADD8E6)
                .iconSet(DULL)
        ...
        Diamminedichloropalladium = REGISTRATE.material(CTNHCore.id("diamminedichloropalladium"))
                .cnlang("二氯二氨络亚钯")
                .dust()
                .color(0x87CEEB)
                .iconSet(METALLIC)
        ...
        SpongePalladium = REGISTRATE.material(CTNHCore.id("sponge_palladium"))
                .cnlang("海绵钯")
                .dust()
                .color(0xB0C4DE)
                .iconSet(SHINY)
        ...
        SpongePlatinum = REGISTRATE.material(CTNHCore.id("sponge_platinum"))
                .cnlang("海绵铂")
                .dust()
                .color(0xE0FFFF)
                .iconSet(BRIGHT)
        ...
        ChloropalladicAcidMixture = REGISTRATE.material(CTNHCore.id("chloropalladic_acid_mixture"))
                .cnlang("氯钯酸混合物")
                .liquid() // 液态混合物
        ...
        // 铂族贵金属残渣（含Rh/Ir/Ru等）
        PlatinumGroupResidue = REGISTRATE.material(CTNHCore.id("platinum_group_residue"))
                .cnlang("铂族贵金属残渣")
                .dust()
                .color(0x4B3621) // 深棕褐色
                .iconSet(ROUGH)
        ...
        // 密陀僧（PbO，铅冶炼副产品）
        Litharge = REGISTRATE.material(CTNHCore.id("litharge"))
                .cnlang("密陀僧")
                .dust()
                .color(0xD4AF37) // 金属金色
                .iconSet(METALLIC)
        ...
        // 贵铅（含Ag/Au的粗铅）
        NobleLead = REGISTRATE.material(CTNHCore.id("noble_lead"))
                .cnlang("贵铅")
                .ingot()
                .color(0x8B8B8B) // 铅灰色
                .iconSet(DULL)
        ...
        // 硝酸浸没溶液（溶解Ag/Pb后的酸性液）
        NitricLeachSolution = REGISTRATE.material(CTNHCore.id("nitric_leach_solution"))
                .cnlang("硝酸浸没溶液")
                .liquid()
                .color(0xADD8E6) // 淡蓝色
                .iconSet(DULL)
        ...
        // 富集惰性混合物（Rh/Ir/Ru富集物）
        EnrichedInertMixture = REGISTRATE.material(CTNHCore.id("enriched_inert_mixture"))
                .cnlang("富集惰性混合物")
                .dust()
                .color(0x696969) // 深灰色
                .iconSet(SHINY)
        ...
        // 含硫酸铑水溶液（Rh₂(SO₄)₃）
        RhodiumSulfateSolution = REGISTRATE.material(CTNHCore.id("rhodium_sulfate_solution"))
                .cnlang("含硫酸铑水溶液")
                .liquid()
                .color(0x9370DB) // 紫罗兰色
                .iconSet(SHINY)
        ...
        // 氢氧化铑（Rh(OH)₃）
        RhodiumHydroxide = REGISTRATE.material(CTNHCore.id("rhodium_hydroxide"))
                .cnlang("氢氧化铑")
                .dust()
                .color(0xC0C0C0) // 浅灰色
                .iconSet(FINE)
        ...
        // 氯铑酸（H₃[RhCl₆]）
        ChlororhodicAcid = REGISTRATE.material(CTNHCore.id("chlororhodic_acid"))
                .cnlang("氯铑酸")
                .liquid()
                .color(0x8B0000) // 暗红色
                .iconSet(SHINY)
        ...
        // 氯铑酸铵晶体（(NH₄)₃[RhCl₆]）
        AmmoniumChlororhodate = REGISTRATE.material(CTNHCore.id("ammonium_chlororhodate"))
                .cnlang("氯铑酸铵")
                .dust()
        ...
        // 海绵铑（高纯度铑粉）
        SpongeRhodium = REGISTRATE.material(CTNHCore.id("sponge_rhodium"))
                .cnlang("海绵铑")
                .dust()
                .color(0xE6E6FA) // 银白色
                .iconSet(SHINY)
                ...
                .setFormula("Rh", true);
        // 珍贵金属混合物
        PreciousMetalMixture = REGISTRATE.material(CTNHCore.id("precious_metal_mixture"))
                .cnlang("珍贵金属混合物")
                .dust()
                .color(0x2F4F4F)  // 深石板灰
                .iconSet(METALLIC)
        ...
        // 过氧化钠粉
        SodiumPeroxide = REGISTRATE.material(CTNHCore.id("sodium_peroxide"))
                .cnlang("过氧化钠")
                .dust()
                .liquid()
                .color(0xFFECB3)
        ...
        // 氯锇酸气体
        ChlorosmicAcidGas = REGISTRATE.material(CTNHCore.id("chlorosmic_acid_gas"))
                .cnlang("氯锇酸")
                .gas()
                .color(0xDA70D6)
                .buildAndRegister()
        ...
        // 氯钌酸气体
        ChlororuthenicAcidGas = REGISTRATE.material(CTNHCore.id("chlororuthenic_acid_gas"))
                .cnlang("氯钌酸")
                .gas()
                .color(0xBA55D3)
                .buildAndRegister()
        ...
        // 氯锇酸铵
        AmmoniumChlorosmate = REGISTRATE.material(CTNHCore.id("ammonium_chlorosmate"))
                .cnlang("氯锇酸铵")
                .dust()
                .color(0x8A2BE2)
                .buildAndRegister()
        ...
        // 氯钌酸铵
        AmmoniumChlororuthenate = REGISTRATE.material(CTNHCore.id("ammonium_chlororuthenate"))
                .cnlang("氯钌酸铵")
                .dust()
                .color(0x9932CC)
                .buildAndRegister()
        ...
        SodiumOsmateRuthenateChlorideSolution = REGISTRATE
                .material(CTNHCore.id("sodium_osmate_ruthenate_chloride_solution"))
                .cnlang("锇酸钠-钌酸钠-氯化溶液")
                .liquid()                      // 液态
        ...
        // 乙醛
        Acetaldehyde = REGISTRATE.material(CTNHCore.id("acetaldehyde"))
                .cnlang("乙醛")
