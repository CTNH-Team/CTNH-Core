...
public class PlatinumLineMaterials {
    public static void init() {
        ...
        PalladiumMetal = REGISTRATE.material(CTNHCore.id("palladium_metal")).cnlang("钯金属").dust().color(0x30302E).iconSet(SAND).flags(DISABLE_DECOMPOSITION)
                .buildAndRegister().setFormula("??Pd??");
        PlatinumMetal = REGISTRATE.material(CTNHCore.id("platinum_metal")).cnlang("铂金属").dust().color(0xEBEBB2).iconSet(ROUGH).flags(DISABLE_DECOMPOSITION)
        ...
        IridiumDioxide = REGISTRATE.material(CTNHCore.id("iridium_dioxide")).cnlang("二氧化铱").dust().color(0xA2BFFF).iconSet(METALLIC)
                .flags(DISABLE_DECOMPOSITION).buildAndRegister().setFormula("IrO2");
        //新铂材料
        GoldPlatinumPalladiumAcidSolution = REGISTRATE.material(CTNHCore.id("gold_platinum_palladium_acid_solution")).cnlang("金-铂-钯酸性溶液")
                .liquid()
                .color(0xFFD700)
                .iconSet(DULL)
                .buildAndRegister()
        ...
        DenitratedGoldPlatinumPalladiumSolution = REGISTRATE.material(CTNHCore.id("denitrated_gold_platinum_palladium_solution")).cnlang("除硝金-铂-钯酸性溶液")
                .liquid()
                .color(0x8A2BE2)
                .iconSet(SHINY)
                .buildAndRegister()
        ...
        ChloroplatinicChloropalladicSolution = REGISTRATE.material(CTNHCore.id("chloroplatinic_chloropalladic_solution")).cnlang("氯铂酸-氯钯酸混合溶液")
                .liquid()
                .color(0x9370DB)
                .iconSet(SHINY)
                .buildAndRegister()
...
// 浓缩氯铑酸铵溶液（(NH₄)₃[RhCl₆]）
        ConcentratedAmmoniumChlororhodate = REGISTRATE.material(CTNHCore.id("concentrated_ammonium_chlororhodate")).cnlang("浓缩氯铑酸铵溶液")
                .liquid()
                .color(0xFF6347) // 橙红色
                .iconSet(BRIGHT)
                .buildAndRegister()
...
//氯铑酸铵溶液
        AmmoniumChlororhodateSolution = REGISTRATE.material(CTNHCore.id("ammonium_chlororhodate_solution")).cnlang("氯铑酸铵溶液")
                .liquid()                      // 液态
...
// 锇酸钠-钌酸钠混合溶液
        SodiumOsmateRuthenateSolution = REGISTRATE.material(CTNHCore.id("sodium_osmate_ruthenate_solution")).cnlang("锇酸钠-钌酸钠混合溶液")
                .liquid()
                .color(0x8A2BE2)
                .buildAndRegister()
...
// 锇酸钠-钌酸钠-氯化溶液（含OsO₄²⁻/RuO₄²⁻/Cl⁻）
        SodiumOsmateRuthenateChlorideSolution = REGISTRATE.material(CTNHCore.id("sodium_osmate_ruthenate_chloride_solution")).cnlang("锇酸钠-钌酸钠-氯化溶液")
                .liquid()                      // 液态
