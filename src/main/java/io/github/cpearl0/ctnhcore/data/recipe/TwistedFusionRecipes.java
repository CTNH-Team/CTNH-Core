...
public class TwistedFusionRecipes {
    public static void init(Consumer<FinishedRecipe> provider) {
        TWISTED_FUSION.recipeBuilder("twist_power_mana")
                ...
                .duration(16)
                .save(provider);
        TWISTED_FUSION.recipeBuilder("caesium_argon")
                ...
                .duration(16)
                .save(provider);
        TWISTED_FUSION.recipeBuilder("carbon_iridium")
                ...
                .duration(16)
                .save(provider);
        TWISTED_FUSION.recipeBuilder("fluorine_trinium")
                ...
                .duration(16)
                .save(provider);
        TWISTED_FUSION.recipeBuilder("carbon_krypton")
                .inputFluids(Potassium.getFluid(144))
                .inputFluids(Chromium.getFluid(144))
                .outputFluids(Carbon.getFluid(144))
                ...
                .duration(16)
                .save(provider);
        TWISTED_FUSION.recipeBuilder("sulfur_indium")
                .inputFluids(Iodine.getFluid(144))
                ...
                .duration(16)
                .save(provider);
        TWISTED_FUSION.recipeBuilder("potassium_duranium")
                ...
                .duration(16)
                .save(provider);
        TWISTED_FUSION.recipeBuilder("neon_fluorine")
                .inputFluids(Iron.getFluid(144))
                ...
                .duration(16)
                .save(provider);
        TWISTED_FUSION.recipeBuilder("tritanium_deuterium")
                ...
                .duration(16)
                .save(provider);
        TWISTED_FUSION.recipeBuilder("neutronium_phosphorus")
                .inputFluids(Nitrogen.getFluid(1000))
