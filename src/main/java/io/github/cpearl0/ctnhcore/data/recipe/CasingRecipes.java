...
public class CasingRecipes {
    public static void init(Consumer<FinishedRecipe> provider) {
        GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("osmiridium_casing")
        ...
        GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("reflect_light_casing")
        ...
        GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("bio_reactor_casing")
        ...
        GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("sturdy_machine_casing")
        ...
        GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("naquadah_casing_block")
        ...
        GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("naquadah_alloy_casing_block")
        ...
        GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("tungstencu_diamond_plating_casing")
