...
public class PlatinumLine {
    public static void init(Consumer<FinishedRecipe> provider) {
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("platinum_slurry_aqua_regia")
                .inputItems(TagPrefix.dust,PlatinumGroupSludge,3) // 单槽位输入
                ...
                .outputItems(TagPrefix.dust,CTNHMaterials.PlatinumGroupResidue,1)
                .EUt(GTValues.VA[GTValues.HV])
                .duration(640)
                .save(provider);
//溶液线
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("denitrate_gold_platinum_palladium_solution") //反复除硝
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("ferrous_reduction_denitrated_solution")
                ...
                .outputItems(TagPrefix.dust,Gold,1)                                          // 金粉（Au）
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("ammonium_chloroplatinate_synthesis")
                ...
                .inputItems(TagPrefix.dust,AmmoniumChloride,4)                           // 氯化铵固体（2个，对应2000mb溶液当量）
                .outputItems(TagPrefix.dust,CTNHMaterials.AmmoniumChloroplatinate,9)                // 氯铂酸铵沉淀（(NH₄)₂[PtCl₆]）
        ...
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("ammonium_chloroplatinate_calcination")
                .inputItems(TagPrefix.dust,CTNHMaterials.AmmoniumChloroplatinate,9)  // 氯铂酸铵粉末（9个）
                .outputItems(TagPrefix.dust,GTMaterials.AmmoniumChloride,4)        // 氯化铵粉末（4个）
                .outputItemsRanged(ChemicalHelper.get(TagPrefix.dust, CTNHMaterials.SpongePlatinum), UniformInt.of(1, 3))
        ...
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("sponge_platinum_calcination")
                .inputItems(TagPrefix.dust,CTNHMaterials.SpongePlatinum,1)  // 海绵铂（1个）
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("palladium_ammonia_precipitation")
                ...
                .outputItems(TagPrefix.dust,CTNHMaterials.Diamminedichloropalladium,2) // 二氯二氨络亚钯
        ...
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("palladium_ammine_hydrogen_reduction")
                .inputItems(TagPrefix.dust,CTNHMaterials.Diamminedichloropalladium,5)  // 二氯二氨络亚钯（5个）
                .inputFluids(GTMaterials.Hydrogen.getFluid(2000))                 // 氢气（2000mb，过量）
                .outputItemsRanged(ChemicalHelper.get(TagPrefix.dust, CTNHMaterials.SpongePalladium), UniformInt.of(1, 2))          // 海绵钯（1个，纯度>99.7%）SpongePalladium
                .outputItems(TagPrefix.dust,GTMaterials.AmmoniumChloride,4)        // 氯化铵粉末（4个）
        ...
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("sponge_palladium_smelting")
                .inputItems(TagPrefix.dust, CTNHMaterials.SpongePalladium,1)
...
//残渣线
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("platinum_residue_smelting")
                .inputItems(TagPrefix.dust, CTNHMaterials.PlatinumGroupResidue, 1)  // 铂族残渣粉（1个）
                .inputItems(TagPrefix.dust, CTNHMaterials.Litharge, 2)            // 密陀僧粉（1个）
                .inputItems(TagPrefix.dust, GTMaterials.Carbon, 1)                // 碳粉（1个）
                .outputItems(TagPrefix.dust, CTNHMaterials.NobleLead, 1)          // 贵铅粉（1个）
        ...
        GTRecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder("noble_lead_nitric_leach")
                .inputItems(TagPrefix.dust, CTNHMaterials.NobleLead, 1)      // 贵铅粉（1个）
                .inputFluids(GTMaterials.NitricAcid.getFluid(1000))          // 硝酸（1000mb）
                .outputFluids(NitricLeachSolution.getFluid(1000)) // 硝酸浸没溶液
                .outputItems(TagPrefix.dust, CTNHMaterials.EnrichedInertMixture, 1) // 富集惰性混合物粉
                .EUt(GTValues.VA[GTValues.HV])     // 中电压（480 EU/t）
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder("nitric_leach_electrolysis")
                ...
                .outputItems(TagPrefix.dust, GTMaterials.Silver, 1)  // 槽位1
                .outputItems(TagPrefix.dust, GTMaterials.Lead, 1)    // 槽位2
        ...
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("enriched_inert_mixture_sulfate_conversion")
                .inputItems(TagPrefix.dust, CTNHMaterials.EnrichedInertMixture, 2)  // 富集惰性混合物粉（2个）
                ...
                .outputItems(TagPrefix.dust,SodiumSulfate, 21)
                .outputItems(TagPrefix.dust,PreciousMetalMixture, 1)
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("rhodium_sulfate_to_hydroxide")
                ...
                .inputItems(TagPrefix.dust, GTMaterials.SodiumHydroxide, 18)        // 6个氢氧化钠粉
                .outputItems(TagPrefix.dust, CTNHMaterials.RhodiumHydroxide, 8)    // 8个氢氧化铑粉
                .outputItems(TagPrefix.dust,SodiumSulfate, 21)       // 21个硫酸钠粉
        ...
        GTRecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder("rhodium_hydroxide_to_chlororhodic_acid")
                .inputItems(TagPrefix.dust, CTNHMaterials.RhodiumHydroxide, 4)  // 4个氢氧化铑粉
        ...
        GTRecipeTypes.AUTOCLAVE_RECIPES.recipeBuilder("ammonium_chlororhodate_crystallization")
                ...
                .inputItems(TagPrefix.dust, CTNHMaterials.AmmoniumChlororhodate, 1)
                .outputItems(TagPrefix.dust, CTNHMaterials.AmmoniumChlororhodate, 2)         // 1个氯铑酸铵粉
                .EUt(GTValues.VA[GTValues.HV])  // 高电压（7,680 EU/t）
                .duration(100)                  // 15秒（300 ticks）
                .save(provider);
        GTRecipeTypes.AUTOCLAVE_RECIPES.recipeBuilder("ammonium_chlororhodate_crystallization_two")
                .inputFluids(CTNHMaterials.ConcentratedAmmoniumChlororhodate.getFluid(1000))  // 1000mb浓缩液
                .outputItems(TagPrefix.dust, CTNHMaterials.AmmoniumChlororhodate, 1)         // 1个氯铑酸铵粉
                .EUt(GTValues.VA[GTValues.HV])  // 高电压（7,680 EU/t）
                .duration(360)                  // 15秒（300 ticks）
                .save(provider);
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("ammonium_chlororhodate_hydrogen_reduction")
                .inputItems(TagPrefix.dust, CTNHMaterials.AmmoniumChlororhodate, 1)  // 1个氯铑酸铵粉
                .inputFluids(GTMaterials.Hydrogen.getFluid(3000))                     // 1500mb氢气
                .outputItems(TagPrefix.dust, CTNHMaterials.SpongeRhodium, 1)         // 槽位1：1个海绵铑
                .outputItems(TagPrefix.dust, GTMaterials.AmmoniumChloride, 3)        // 槽位2：3个氯化铵粉
        ...
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("sponge_rhodium_smelting")
                .inputItems(TagPrefix.dust, CTNHMaterials.SpongeRhodium, 1)  // 1个海绵铑粉
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("lead_to_litharge_oxidation")
                .inputItems(TagPrefix.dust, GTMaterials.Lead, 1)  // 1个铅粉
                .inputFluids(GTMaterials.Oxygen.getFluid(1000))   // 1000mb氧气（1mol）
                .outputItems(TagPrefix.dust, CTNHMaterials.Litharge, 2)  // 2个密陀僧粉（PbO）
                .EUt(GTValues.VA[GTValues.LV])  // 低电压（30 EU/t）
                .duration(100)                  // 5秒（100 ticks）
                .save(provider);
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("precious_metal_oxidation")
                .inputItems(TagPrefix.dust, CTNHMaterials.PreciousMetalMixture, 1)  // 槽位1：1个贵金属混合物粉
        ...
        GTRecipeTypes.ARC_FURNACE_RECIPES.recipeBuilder("sodium_peroxide_synthesis")
                .inputItems(TagPrefix.dust, GTMaterials.Sodium, 2)  // 2个钠粉
                .inputFluids(GTMaterials.Oxygen.getFluid(2000))      // 2000mb氧气（2mol）
                .outputItems(TagPrefix.dust, CTNHMaterials.SodiumPeroxide, 4)  // 4个过氧化钠粉
        ...
        GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder("osmium_ruthenium_distillation")
                ...
                .outputItems(TagPrefix.dust, GTMaterials.Salt, 8)                   // 8个氯化钠粉
                ...
                .save(provider);
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("osmium_tetroxide_reduction")
                ...
                .duration(300)                   // 15秒（300 ticks）
                .save(provider);
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("ruthenium_tetroxide_reduction")
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("ammonium_chlorosmate_synthesis")
                ...
                .inputItems(TagPrefix.dust, GTMaterials.AmmoniumChloride, 4)  // 4个氯化铵粉
                .outputItems(TagPrefix.dust, CTNHMaterials.AmmoniumChlorosmate, 1)  // 1个氯锇酸铵粉
        ...
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("ammonium_chlorosmate_decomposition")
                .inputItems(TagPrefix.dust, CTNHMaterials.AmmoniumChlorosmate, 1)  // 1个氯锇酸铵粉
                .inputFluids(GTMaterials.Hydrogen.getFluid(4000))                   // 2000mb氢气（2mol）
                .outputItems(TagPrefix.dust, GTMaterials.Osmium, 1)                // 1个锇粉
                .outputItems(TagPrefix.dust, GTMaterials.AmmoniumChloride, 4)      // 4个氯化铵粉
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("ammonium_chlororuthenate_synthesis")
                ...
                .inputItems(TagPrefix.dust, GTMaterials.AmmoniumChloride, 4)      // 4个氯化铵粉
                .outputItems(TagPrefix.dust, CTNHMaterials.AmmoniumChlororuthenate, 1)  // 1个氯钌酸铵粉
                .outputFluids(GTMaterials.HydrochloricAcid.getFluid(2000))              // 2000mb盐酸
                .EUt(GTValues.VA[GTValues.EV])  // 高电压（7,680 EU/t）
                .duration(200)                  // 10秒（200 ticks）
                .save(provider);
        GTRecipeTypes.BLAST_RECIPES.recipeBuilder("ammonium_chlororuthenate_decomposition")
                .inputItems(TagPrefix.dust, CTNHMaterials.AmmoniumChlororuthenate, 1)  // 1个氯钌酸铵粉
                .inputFluids(GTMaterials.Hydrogen.getFluid(4000))                      // 4000mb氢气（4mol）
                .outputItems(TagPrefix.dust, GTMaterials.Ruthenium, 1)                 // 1个钌粉
                .outputItems(TagPrefix.dust, GTMaterials.AmmoniumChloride, 4)         // 4个氯化铵粉
                .outputFluids(GTMaterials.HydrochloricAcid.getFluid(4000))           // 4000mb盐酸
                .blastFurnaceTemp(800)       // 800K（527℃）
                .EUt(GTValues.VA[GTValues.EV]) // 高电压（7,680 EU/t）
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("ferrous_sulfate_synthesis")
                .inputItems(TagPrefix.dust, GTMaterials.Iron, 2)          // 2个铁粉
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("ferric_sulfate_reduction")
                ...
                .inputItems(TagPrefix.dust, GTMaterials.Iron, 1)                 // 1个铁粉
                .inputFluids(GTMaterials.SulfuricAcid.getFluid(3000))      // 3000mb硫酸（3mol）
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder("anhydrous_ferric_sulfate_electrolysis")
                ...
                .outputItems(TagPrefix.dust, GTMaterials.Iron, 2)           // 2个铁粉（Fe）
                .outputItems(TagPrefix.dust, GTMaterials.Sulfur, 3)         // 3个硫粉（S）
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("acetaldehyde_hydrogenation")
                .notConsumable(TagPrefix.dust, GTMaterials.Platinum, 1)
